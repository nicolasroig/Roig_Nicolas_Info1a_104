...
"""
    ...
    Paramètres : order_by : ASC : Ascendant, DESC : Descendant
                id_materiel_sel = 0 >> tous les genres.
                id_materiel_sel = "n" affiche le materiel dont l id est "n"
"""


@obj_mon_application.route("/genres_afficher/<string:order_by>/<int:id_materiel_sel>", methods=['GET', 'POST'])
def genres_afficher(order_by, id_materiel_sel):
        ...
        try:
            ...
            with MaBaseDeDonnee().connexion_bd.cursor() as mc_afficher:
                if order_by == "ASC" and id_materiel_sel == 0:
                    strsql_genres_afficher = """SELECT id_materiel, materiel FROM t_materiel 
                    ...
                    mc_afficher.execute(strsql_genres_afficher, valeur_id_materiel_selected_dictionnaire)
                else:
                    strsql_genres_afficher = """SELECT id_materiel, materiel FROM t_materiel 
                ...
                if not data_genres and id_materiel_sel == 0:
                    flash("""La table "t_materiel" est vide. !!""", "warning")
                elif not data_genres and id_materiel_sel > 0:
...
"""
    ...
    Remarque :  Dans le champ "name_materiel_html" du formulaire "genres/genres_ajouter.html",
    ...
    if request.method == "POST":
        try:
            ...
            if form.validate_on_submit():
                ...
                valeurs_insertion_dictionnaire = {"value_intitule_materiel": name_materiel}
                print("valeurs_insertion_dictionnaire ", valeurs_insertion_dictionnaire)

                strsql_insert_materiel = """INSERT INTO t_materiel (id_materiel,materiel) VALUES (NULL,%(value_id_materiel_selected)s)"""
                ...
                return redirect(url_for('genres_afficher', order_by='DESC', id_materiel_sel=0))
